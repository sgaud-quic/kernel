...
#define CAM_CPAS_PATH_DATA_IFE_RDI4       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 10)
#define CAM_CPAS_PATH_DATA_IFE_RDI5       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 11)
#define CAM_CPAS_PATH_DATA_IFE_RDI6       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 12)
#define CAM_CPAS_PATH_DATA_IFE_RDI7       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 13)
#define CAM_CPAS_PATH_DATA_IFE_RDI8       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 14)
#define CAM_CPAS_PATH_DATA_IFE_RDI9       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 15)
#define CAM_CPAS_PATH_DATA_IFE_RDI10      (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 16)
#define CAM_CPAS_PATH_DATA_IFE_RDI11      (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 17)
#define CAM_CPAS_PATH_DATA_IFE_DS4        (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 18)
#define CAM_CPAS_PATH_DATA_IFE_DS16       (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 19)
#define CAM_CPAS_PATH_DATA_IFE_IR         (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 20)
#define CAM_CPAS_PATH_DATA_IFE_RS         (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 21)
