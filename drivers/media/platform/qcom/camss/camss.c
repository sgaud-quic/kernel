...
static const struct camss_subdev_resources vfe_res_nord[] = {
	/* VFE0 - IFE Full */
	{
		.clock = { "gcc_axi_hf", "vfe0_fast_ahb", "vfe0",
			   "top_ahb", "top_fast_ahb",
			   "top_ife0", "camnoc_rt_axi",
			   "qdss_debug_xo" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 360280000, 480000000, 630000000, 716000000,
